...
const I18N = {
  en: {
    ...
    tour4_h: "Real notifications", tour4_p: "Follows, downloads, friend requests — with native OS alerts, not just a badge you forget to check.",
    tour5_h: "Community & Apps store", tour5_p: "Find and follow other members, and browse everything the community has published — the real public store.",
    tour6_h: "Full docs, built in", tour6_p: "The complete CLI reference plus a Packages tab that drives the real poly command — search, install, remove, no terminal needed.",
    ...
    tour_skip: "Skip", tour_next: "Next →", tour_finish: "Got it →", settings_retour: "Take the tour again",
    tour_step_apps_h: "My apps", tour_step_apps_p: "Everything you've published — drafts and live listings, with quick edit and delete.",
    tour_step_notifications_h: "Notifications", tour_step_notifications_p: "Follows, downloads, friend requests, announcements — with real OS alerts when something new happens.",
    tour_step_packages_h: "Packages", tour_step_packages_p: "Search, install, and remove packages via the real Poly CLI — no terminal needed.",
    tour_step_publish_h: "Publish new app", tour_step_publish_p: "A guided 4-step wizard with a live preview of your store listing as you fill it in.",
    tour_step_docs_h: "Docs", tour_step_docs_p: "The full CLI reference — commands, adapters, poly.json, tap formulas — right here, no browser.",
    tour_step_community_h: "Community", tour_step_community_p: "Find and follow other Poly members.",
    tour_step_appsstore_h: "Apps store", tour_step_appsstore_p: "Browse the real public catalog everyone has published — distinct from \"My apps\".",
    tour_step_settings_h: "Settings", tour_step_settings_p: "Profile, notifications, theme, accent color, and language — all in one place.",
  ...
  fr: {
    ...
    tour4_h: "De vraies notifications", tour4_p: "Abonnés, téléchargements, demandes d'ami — avec de vraies alertes système, pas juste un badge qu'on oublie de regarder.",
    tour5_h: "Communauté & boutique d'apps", tour5_p: "Trouve et suis d'autres membres, et parcours ce que la communauté a publié — la vraie boutique publique.",
    tour6_h: "Toute la doc, intégrée", tour6_p: "La référence CLI complète, plus un onglet Packages qui pilote la vraie commande poly — recherche, installation, suppression, sans terminal.",
    ...
    tour_skip: "Passer", tour_next: "Suivant →", tour_finish: "Compris →", settings_retour: "Revoir la visite guidée",
    tour_step_apps_h: "Mes apps", tour_step_apps_p: "Tout ce que tu as publié — brouillons et fiches en ligne, avec modification et suppression rapides.",
    tour_step_notifications_h: "Notifications", tour_step_notifications_p: "Abonnés, téléchargements, demandes d'ami, annonces — avec de vraies alertes système.",
    tour_step_packages_h: "Packages", tour_step_packages_p: "Recherche, installe et supprime des packages via la vraie CLI Poly — sans terminal.",
    tour_step_publish_h: "Publier une app", tour_step_publish_p: "Un assistant guidé en 4 étapes avec aperçu live de ta fiche pendant que tu remplis.",
    tour_step_docs_h: "Doc", tour_step_docs_p: "La référence CLI complète — commandes, adaptateurs, poly.json, formules tap — ici, sans navigateur.",
    tour_step_community_h: "Communauté", tour_step_community_p: "Trouve et suis d'autres membres Poly.",
    tour_step_appsstore_h: "Boutique d'apps", tour_step_appsstore_p: "Parcours le vrai catalogue public — distinct de « Mes apps ».",
    tour_step_settings_h: "Paramètres", tour_step_settings_p: "Profil, notifications, thème, couleur d'accent et langue — tout au même endroit.",
